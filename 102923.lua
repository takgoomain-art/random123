		...
		if Character
			...
			if PrimaryPart.AssemblyAngularVelocity.Magnitude > 50
				...
				if not Detected then
					WindUI:Notify({
						Title = "Anti Fling",
						Content = "Fling detected: " .. Player.Name,
						Duration = 3
					})
				end
			...
			HeartbeatConnection = Services.RunService.Heartbeat:Connect(function()
				...
				pcall(function()
					...
					if PrimaryPart.AssemblyLinearVelocity.Magnitude > 250
						...
						WindUI:Notify({
							Title = "Anti Fling",
							Content = "Fling neutralized",
							Duration = 3
						})

					elseif PrimaryPart.AssemblyLinearVelocity.Magnitude < 50
						or PrimaryPart.AssemblyAngularVelocity.Magnitude < 50 then
